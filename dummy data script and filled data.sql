...
SET @product1 := LAST_INSERT_ID();
SET @product2 := LAST_INSERT_ID() - 1;
SET @product3 := LAST_INSERT_ID() - 2;
SET @product4 := LAST_INSERT_ID() - 3;
SET @product5 := LAST_INSERT_ID() - 4;
...
SET @address2 := LAST_INSERT_ID() - 1;

-- Insert web order data
INSERT INTO web_order (address_id, user_id) VALUES (@address1, 3);
INSERT INTO web_order (address_id, user_id) VALUES (@address1, 3);
INSERT INTO web_order (address_id, user_id) VALUES (@address1, 3);
INSERT INTO web_order (address_id, user_id) VALUES (@address2, 4);
INSERT INTO web_order (address_id, user_id) VALUES (@address2, 4);

-- Retrieve order IDs
SET @order1 := LAST_INSERT_ID();
SET @order2 := LAST_INSERT_ID() - 1;
SET @order3 := LAST_INSERT_ID() - 2;
SET @order4 := LAST_INSERT_ID() - 3;
SET @order5 := LAST_INSERT_ID() - 4;

-- Insert web order quantities data
INSERT INTO web_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product1, 5);
INSERT INTO web_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product2, 5);
INSERT INTO web_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product3, 5);
INSERT INTO web_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product2, 5);
